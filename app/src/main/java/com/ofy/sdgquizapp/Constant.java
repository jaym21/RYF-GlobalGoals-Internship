...
public class Constant {
    ...
    public static String QUIZ_URL = "http://sdg.offy.xyz/api-v2.php";
    //"http://192.168.43.208/ryf/api-v2.php";  //localhost api url

    //"https://quizdemo.wrteam.in/api-v2.php";
    ...
    public static final String D_LANG_ID = "1"; // I CHANGED FROM -1 TO 1
