...
import com.ofy.sdgquizapp.model.Level;
...
public class LevelActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dbHelper = new DBHelper(LevelActivity.this);
        ...
        if(MainActivity.dbHelper!=null)
           ...
           levelNo = new DBHelper(getApplicationContext()).GetLevelById(Constant.CATE_ID, Constant.SUB_CAT_ID);
        // changed from MainActivity.dbHelper.GetLevelById(Constant.CATE_ID, Constant.SUB_CAT_ID);
        // sometimes MainActivity.dbHelper becoming null
            ...
            viewHolder.relativeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (levelNo >= position + 1) {
                        ...
                        finish(); //my addition, because MainActivity.dbHelper is getting null in this activity
                    } else {
